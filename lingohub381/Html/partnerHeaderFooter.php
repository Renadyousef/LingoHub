...
<header id="PartnerHPage">
        ...
        <div >
            <button class="cta" onclick="window.location.href='../PHP/logoutprocess.php'">Sign out</button>
        </div>
    </header>
<footer>
                 <table class="tableF">
                    <tr>
                        ...
                        <th><a href="FAQ.php"> FAQs </a></th>
                        <th><a href="ContactUs.hphp"> Contact Us </a></th>
                    </tr>
                </table>
              <div class="icons">
