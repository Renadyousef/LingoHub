...
if(!$database = mysqli_select_db($connection, dbname))
   ...
   if($_POST['pass'] === $_SESSION['password']) {
    ...
    $delete_query = "DELETE FROM `learner` WHERE learnerID ='" . $_SESSION["ID"] . "'";
...
function cancelFormSubmission() {
    ...
    window.location.href = 'learner-profile.php';
}
</script>
</head>
        ...
        <div class="right">
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                ...
                <div class="button-container2">
                    ...
                    <button class="contact" onclick="cancelFormSubmission()" >Cancel</button>
                </div>
            </form>
            <!--<ul id="delete">
