...
if(!$database = mysqli_select_db($connection, dbname))
   ...
   if($_POST['pass'] === $_SESSION['password']) {
    ...
    $delete_query = "DELETE FROM `partner` WHERE `partnerID`='" . $_SESSION["ID"] . "'";
...
function cancelFormSubmission() {
    ...
    window.location.href = 'partner-Profile.php';
}
</script>
        ...
        <div class="right">
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                ...
                <div class="button-container2">
                    <button class="reject" type="submit" name="delete_profile" >Delete</button>
                    <button class="contact" type="submit" onclick="cancelFormSubmission()">Cancel</button>
