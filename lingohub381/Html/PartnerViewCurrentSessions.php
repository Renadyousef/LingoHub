...
// SQL query to fetch current and upcoming sessions along with learner and language details
...
<body>
    ...
    while($row = $result->fetch_assoc()): ?>
        <div class="session-info">
                 <img src="<?php echo htmlspecialchars($row['photo']); ?>" alt="Learner picture">
                 <span class="<?php echo 'fi fi-' . strtolower($row['LanguageCode']); ?>"></span>
            <p>
                <span class="session-learner-label">Learner Name:</span>
                <span class="session-learner"><?php echo htmlspecialchars($row['firstName']) . ' ' . htmlspecialchars($row['lastName']); ?></span>
                <br>
